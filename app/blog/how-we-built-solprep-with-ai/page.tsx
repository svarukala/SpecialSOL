...
const JSON_LD = [
  {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 3, name: 'How We Used AI to Build SolPrep', item: 'https://solprep.app/blog/how-we-built-solprep-with-ai' },
    ],
  },
  {
    '@context': 'https://schema.org',
    '@type': 'Article',
    headline: 'How We Used AI to Build SolPrep — From PDF to Practice Questions',
    datePublished: '2026-04-05',
    author: { '@type': 'Organization', name: 'SolPrep' },
    publisher: { '@type': 'Organization', name: 'SolPrep', url: 'https://solprep.app' },
    url: 'https://solprep.app/blog/how-we-built-solprep-with-ai',
  },
]
