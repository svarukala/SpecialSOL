...
const JSON_LD = [
  {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 3, name: "How to Read Your Child's SOL Score Report", item: 'https://solprep.app/blog/how-to-read-sol-score-report' },
    ],
  },
  {
    '@context': 'https://schema.org',
    '@type': 'Article',
    headline: "How to Read Your Child's SOL Score Report",
    datePublished: '2026-05-05',
    author: { '@type': 'Organization', name: 'SolPrep' },
    publisher: { '@type': 'Organization', name: 'SolPrep', url: 'https://solprep.app' },
    url: 'https://solprep.app/blog/how-to-read-sol-score-report',
  },
]
